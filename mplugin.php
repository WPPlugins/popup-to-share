...
<iframe src="http://www.facebook.com/plugins/like.php?href='. $elpermalinkf .'
...
<script type="text/javascript">
  ...
  if ($publi1 == 'Si'){  
     ...
     $banner= $banner . '  <div id="apDiv5"><div align="center">
        <a href="http://www.codigojavaoracle.com/" target="_blank">Powered by www.CodigoJavaOracle.com</a> </div></div>  ';

} 
   else { 
    $banner= $banner .' <div id="apDiv5"><div align="center">Ver. 1.0</div></div> ';
   }
